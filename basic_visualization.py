...
def steering_loop(model_path, data_path):
    ...
    for i in range(configs.LENGTH):
        img = cv2.imread(data_path + str(i) + ".png")
        img = cv2.cvtColor(img, cv2.COLOR_BGR2RGB)
        inputs.append(cv2.resize(img, (224, 224)))

    # Run through all images
    for i in range(configs.LENGTH, len(files)):
...
if __name__ == "__main__":
    ...
    steering_loop(model_path='i3d_vehicle_dataset_1.h5', data_path='/hdd/ssd_2/dataset/golf-cart/Dataset/Dataset_Part1/center/')